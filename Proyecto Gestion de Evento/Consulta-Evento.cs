...
{
    public partial class Consulta_Evento : Form
    {
        ...
        private void MostrarDatos(string sql) //recibe un parámetro con la instrucción sql deseada
        {
            ...
            try
            {
                ...
                bindingNavigator2.BindingSource = mi_bindingsource; //tanto del gridview como del navigator
            }
            catch
            {
        ...
        {
            Reporte_Evento fmant_cargo = new Reporte_Evento(); fmant_cargo.ShowDialog();
        }

        private void Consulta_Evento_Load(object sender, EventArgs e)
        {
        ...
        {
            MostrarDatos("Select * From Evento Where (" + cbBusquedas.Text + " Like '%" + tbBuscar.Text + "%')");
            tbBuscar.Focus();
        }
        ...
        private void Consulta_Evento_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void cbBusquedas_SelectedIndexChanged(object sender, EventArgs e)
        {
